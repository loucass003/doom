...
SRC+=arrays/objs.c
SRC+=arrays/walls.c
SRC+=arrays/two_dvertices.c
SRC+=arrays/three_dvertices.c
...
SRC+=image/image.c
SRC+=image/line.c
SRC+=multithreading/binary_semaphore.c
SRC+=multithreading/thread.c
SRC+=multithreading/threadpool_utils.c
SRC+=multithreading/threadpool.c
SRC+=multithreading/thread_job.c
SRC+=get_file_name.c
SRC+=render.c
SRC+=player.c
