...
/*   Updated: 2019/09/03 17:52:35 by llelievr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// if (collidable->parent_type == PARENT_COLLIDER_OBJ)
	// 	printf("IN\n", collidable->parent_type);
	...
	// if (collidable->parent_type == PARENT_COLLIDER_OBJ)
	// 	printf("OUT %f %f %f\n", collidable->points[0].x, collidable->points[0].y, collidable->points[0].z);
